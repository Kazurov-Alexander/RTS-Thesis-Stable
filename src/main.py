...
def main(display_mode=pg.FULLSCREEN):
    ...
    while running:
        ...
        option_rects = draw_menu(screen, mode, settings_submode, settings.CURRENT_VOLUME)
                    ...
                    if isinstance(rect, pg.Rect) and rect.collidepoint(mouse_pos):
                        if option == "Выход":
                            ...
                            try:
                                ...
                                screen = pg.display.set_mode((w, h), display_mode)
                            except:
                                pass
                        ...
                        elif option == "volume_slider" and settings_submode == "volume":
                            dragging = True
